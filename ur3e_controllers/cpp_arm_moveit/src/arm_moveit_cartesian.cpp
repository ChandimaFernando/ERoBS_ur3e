...
class MinimalSubscriber : public rclcpp::Node
{
  public:
    ...
    : Node("minimal_subscriber")
    {
      ...
      "pickup_waypoint", 10, std::bind(&MinimalSubscriber::topic_callback, this, _1));
    }
...
void topic_callback(geometry_msgs::msg::Point &msg){
...
int main(int argc, char* argv[])
{
  ...
  // subscription_ = node->create_subscription<geometry_msgs::msg::Point>( "pickup_waypoint", 10, std::bind(&topic_callback, this, _1));
  subscription_ = node->create_subscription<geometry_msgs::msg::Point>( "pickup_waypoint", 10, std::bind(&topic_callback, node, _1));
